...
mod integration_tests {
    ...
    #[test]
    #[ignore = "Requires reth test infrastructure"]
    fn mote_executor_creates_entity_in_state() {
        let _exp_idx = Arc::new(Mutex::new(ExpirationIndex::new()));
        todo!("Implement with reth test infrastructure")
    }

    #[test]
    #[ignore = "Requires reth test infrastructure"]
    fn non_mote_tx_delegates_to_inner() {
        todo!("Implement with reth test infrastructure")
    }

    #[test]
    #[ignore = "Requires reth test infrastructure"]
    fn expiration_housekeeping_zeroes_expired_entities() {
        todo!("Implement with reth test infrastructure")
    }
